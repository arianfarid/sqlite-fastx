...
## Context
The `sqlite-fastx` extension's current implementation of a descriptor string, derived from `best_index`, implicitly assigns columns to ops. This is because pushdown filters currently only operate on two columns of two differing types. 
